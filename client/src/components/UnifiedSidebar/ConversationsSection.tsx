...
const ConversationsSection = memo(() => {
  ...
  const [isPinnedAgentsExpanded, setIsPinnedAgentsExpanded] = useLocalStorage('pinnedAgentsExpanded', true);
  const [isPinnedChatsExpanded, setIsPinnedChatsExpanded] = useLocalStorage('pinnedChatsExpanded', true);
