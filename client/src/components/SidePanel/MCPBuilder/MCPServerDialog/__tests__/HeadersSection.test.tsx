...
jest.mock('@librechat/client', () => {
  ...
  return {
    ...
    SecretInput: ActualReact.forwardRef<HTMLInputElement, React.InputHTMLAttributes<HTMLInputElement>>(
      (props, ref) =>
        ActualReact.createElement('input', { ref, type: 'password', 'data-testid': 'secret-input', ...props }),
    ),
  ...
  const methods = useForm<MCPServerFormData>({
    defaultValues: {
      ...
      auth: {
        ...
        api_key_authorization_type: 'bearer' as MCPServerFormData['auth']['api_key_authorization_type'],
...
describe('HeadersSection – secret toggle', () => {
  it('renders the "Mark as secret" button (LockOpen icon) when isSecret is false', () => {
    render(
      <Wrapper
        defaultValues={{ headers: [{ key: 'X-Test', value: 'value', isSecret: false }] }}
      />,
    );
  ...
  it('renders a plain text input for a non-secret header', () => {
    render(
      <Wrapper
        defaultValues={{ headers: [{ key: 'X-Public', value: 'pub', isSecret: false }] }}
      />,
    );
  ...
  it('has aria-pressed="false" on the secret toggle when isSecret is false', () => {
    render(
      <Wrapper
        defaultValues={{ headers: [{ key: 'X-Public', value: 'val', isSecret: false }] }}
      />,
    );
  ...
  it('switches to secret input after clicking the secret toggle', () => {
    render(
      <Wrapper
        defaultValues={{ headers: [{ key: 'X-Token', value: 'abc', isSecret: false }] }}
      />,
    );
