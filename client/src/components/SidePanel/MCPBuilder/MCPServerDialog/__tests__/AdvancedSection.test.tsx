...
jest.mock('@librechat/client', () => {
  ...
  return {
    ...
    Label: ({ children, htmlFor, ...rest }: { children: React.ReactNode; htmlFor?: string; [key: string]: unknown }) =>
...
describe('AdvancedSection – chat menu checkbox', () => {
  it('renders the chat menu checkbox with correct label', () => {
    ...
    expect(screen.getByText('Display this server in the chat menu for quick access')).toBeInTheDocument();
  });
